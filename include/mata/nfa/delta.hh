...
public:
    ...
    public:
        ...
        public:
            ...
            /// Construct all symbols iterator.
            const_iterator(const StatePost& state_post);
            /// Construct epsilons or normal symbols (excluding epsilons) iterator.
        ...
        const_iterator begin() const { return const_iterator{ *state_post_, first_symbol_, last_symbol_, first_symbol_lookup_direction_ }; }
        const_iterator end() const { return const_iterator{}; }
    private:
        const StatePost* state_post_;
        Symbol first_symbol_{ Limits::min_symbol };
        Symbol last_symbol_{ Limits::max_symbol };
    ...
    /**
     * Iterator over moves over normal symbols (not over epsilons) represented as 'Move' instances.
     */
